    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <section className="relative h-[300px] md:h-[400px] overflow-hidden">
          <Image
            src="/images/about-hero.png?height=400&width=1200&text=About+HH+Plumbing+and+Gas"
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center">
            <div className="container mx-auto px-4">
              ...
              <p className="text-xl text-white max-w-2xl">
                Professional plumbing and heating specialists committed to
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
                HH Plumbing and Gas is a trusted provider of professional
                plumbing and heating services across London. With years of
                experience in the industry, we've built our reputation on
                delivering exceptional workmanship, reliable service, and
                competitive pricing.
              </p>
              <p className="text-lg mb-8 text-gray-700 dark:text-gray-300">
                Our team of skilled engineers is committed to providing the
                highest standards of service, ensuring that every installation,
                repair, or maintenance job is completed to perfection. We take
                pride in our work and strive to exceed our customers'
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">
                      <strong>Gas Safe Registered</strong> - Ensuring all gas
                      work is performed safely and legally
                    </span>
                  </li>
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-brand-yellow mr-2 mt-1 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <Check className="h-5 w-5 text-brand-yellow mr-2 mt-1 flex-shrink-0" />
                    <span className="text-gray-700 dark:text-gray-300">
                      <strong>Approved Installer</strong> - Recognized by
                      leading manufacturers including Vaillant, Worcester Bosch,
                      and Baxi
                    </span>
                  </li>
                </ul>
            ...
            <div className="space-y-8">
              <div className="relative h-[400px] rounded-lg overflow-hidden shadow-lg">
                <Image
                  src="/images/about-gas-water-heater-installation.jpeg?height=400&width=600&text=Professional+Team"
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              We offer a comprehensive range of plumbing and heating services at
              competitive prices. Our team specializes in boiler installations,
              heat pump systems, underfloor heating, and more.
            </p>
            <div className="mt-8">
              <Link
                href="/services"
